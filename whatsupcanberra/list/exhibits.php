...
<body>
<div class="header">What'sUp Canberra - Exhibits<a href="../"><img src="../images/home-50.png" alt=Home /></a></div>
...
function makeUL(json) {
    ...
    for (var i = 0; i < json.length; i++) {
    	if (typeof json[i].categories[0] != "undefined") {
	    	if (json[i].categories[0].typeid == "EXHIBIT" && json[i].name != null) {
	    		index += 1
