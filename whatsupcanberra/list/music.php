...
<title>
What'sUp Canberra - Music
</title>
<link type="text/css" rel="stylesheet" href="list.css">
</head>
<script src="http://code.jquery.com/jquery-1.9.1.js"></script>
<body>
<div class="header">What'sUp Canberra - Music<a href="../"><img src="../images/home-50.png" alt=Home /></a></div>
...
function makeUL(json) {
    ...
    for (var i = 0; i < json.length; i++) {
    	if (typeof json[i].categories[0] != "undefined") {
	    	if (json[i].categories[0].typeid == "PERFMUSIC" && json[i].name != null) {
	    		index += 1
